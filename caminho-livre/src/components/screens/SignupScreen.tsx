  ...
  return (
    <div className="flex h-full flex-col">
      <div className="px-6 pt-8">
        ...
        <p className="my-1.5 mb-5 text-[14.5px] text-muted">{tr.signupSub}</p>
      </div>
      ...
      <div className="px-6 pb-5.5 text-center">
        <span onClick={actions.goLogin} className="cursor-pointer text-[14.5px] font-semibold text-accent">
